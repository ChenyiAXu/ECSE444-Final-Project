...
#define AI_NETWORK_MODEL_SIGNATURE     "14ae4671d80c9e77e0e76c42f205bc45"
...
#define AI_TOOLS_DATE_TIME   "Tue Nov 28 14:00:43 2023"
...
/* Array#6 */
AI_ARRAY_OBJ_DECLARE(
  conv1d_3_conv2d_weights_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 10240, AI_STATIC)
/* Array#7 */
AI_ARRAY_OBJ_DECLARE(
  conv1d_3_conv2d_bias_array, AI_ARRAY_FORMAT_FLOAT,
...
/* Array#13 */
AI_ARRAY_OBJ_DECLARE(
  conv1d_3_conv2d_output_array, AI_ARRAY_FORMAT_FLOAT,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  4, 0x0,
  AI_SHAPE_INIT(4, 3, 1, 5, 64), AI_STRIDE_INIT(4, 4, 12, 768, 768),
...
/* Tensor #6 */
AI_TENSOR_OBJ_DECLARE(
  conv1d_3_conv2d_weights, AI_STATIC,
  6, 0x0,
  AI_SHAPE_INIT(4, 64, 1, 5, 32), AI_STRIDE_INIT(4, 4, 256, 8192, 8192),
  1, &conv1d_3_conv2d_weights_array, NULL)

/* Tensor #7 */
AI_TENSOR_OBJ_DECLARE(
  conv1d_3_conv2d_bias, AI_STATIC,
  7, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 1, 1), AI_STRIDE_INIT(4, 4, 4, 128, 128),
  1, &conv1d_3_conv2d_bias_array, NULL)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 1, 22), AI_STRIDE_INIT(4, 4, 4, 256, 256),
...
/* Tensor #13 */
AI_TENSOR_OBJ_DECLARE(
  conv1d_3_conv2d_output, AI_STATIC,
  13, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 1, 18), AI_STRIDE_INIT(4, 4, 4, 128, 128),
  1, &conv1d_3_conv2d_output_array, NULL)
...
/* Tensor #16 */
AI_TENSOR_OBJ_DECLARE(
  activation_4_output0, AI_STATIC,
  16, 0x0,
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &activation_4_output0),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_2_dense_output),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv1d_3_conv2d_output),
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  conv1d_3_conv2d_chain, AI_STATIC_CONST, 4,
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &activation_3_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv1d_3_conv2d_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 3, &conv1d_3_conv2d_weights, &conv1d_3_conv2d_bias, NULL),
  AI_TENSOR_LIST_OBJ_EMPTY
)

AI_LAYER_OBJ_DECLARE(
  conv1d_3_conv2d_layer, 4,
  CONV2D_TYPE, 0x0, NULL,
  conv2d, forward_conv2d_if32of32wf32,
  &conv1d_3_conv2d_chain,
...
AI_LAYER_OBJ_DECLARE(
  activation_3_layer, 2,
  NL_TYPE, 0x0, NULL,
  nl, forward_relu,
  &activation_3_chain,
  NULL, &conv1d_3_conv2d_layer, AI_STATIC, 
  .nl_params = NULL, 
)
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 194456, 1, 1),
    194456, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
